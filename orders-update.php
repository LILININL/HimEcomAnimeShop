...
/*
        ...
        if($query){
          while ($obj = $query->fetch_object()){
            ...
            $message .= '<p><strong>วันที่ ซื้อสินค้า</strong>: '.$obj->date.'</p>';
            $message .= '<p><strong>รหัสสินค้า</strong>: '.$obj->product_code.'</p>';
            $message .= '<p><strong>ชื่อสินค้า</strong>: '.$obj->product_name.'</p>';
            $message .= '<p><strong>จำนวนราคาสินค้าต่อชิ้น</strong>: '.$obj->price.'</p>';
            $message .= '<p><strong>จำนวนสินค้า</strong>: '.$obj->units.'</p>';
            $message .= '<p><strong>รวม ราคาสินค้าทั้งหมด</strong>: '.$obj->total.'</p>';
            $message .= "</body></html>";
            $headers = "From: himchumwong@gmail.com";
