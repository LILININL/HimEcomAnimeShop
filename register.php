...
<html class="no-js" lang="en">
  <head>
    ...
    <title>สมัคสมาชิค || HIM Anime Shop</title>
        ...
        <div class="small-8">
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="ชื่อ" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="นามสกุล" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="ที่อยู่" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="จังหวัด" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="000000" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Himhim@gmail.com" name="Email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
